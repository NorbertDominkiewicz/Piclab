...
public class LinearSlider extends JSlider{
    private int previousValue = 100;
    public LinearSlider(App app) {
        super(-100, 100, 0);
        ...
        addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                app.layout.middlePanel.drawingPanel.photoManager.getActivePhoto().changeBrightness(a,difference);
            }
        });
    }
