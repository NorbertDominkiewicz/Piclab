...
public class ContrastSlider extends JSlider {private int previousValue = 100;
    public ContrastSlider(App app) {
        super(-100, 100, 0);
        ...
        addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                app.layout.middlePanel.drawingPanel.photoManager.getActivePhoto().changeContrast(difference);
            }
        });
    }
